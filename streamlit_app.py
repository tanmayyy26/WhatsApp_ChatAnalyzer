...
if uploaded_file:
    ...
    if word_counts:
        ...
        with col1:
            ...
            st.dataframe(top_words_df.head(10), use_container_width=True, hide_index=True)
        with col2:
            st.markdown("**Top 11-20:**")
            st.dataframe(top_words_df.tail(10), use_container_width=True, hide_index=True)
